...
class PullScheduledFlights extends Command
{
    ...
    public function handle()
    {
        ...
        // Do departures
        $res = $client->request('GET', 'https://flightxml.flightaware.com/json/FlightXML3/AirlineFlightSchedules?start_date=1561845600&end_date=1561863600&origin=KATL&exclude_codeshare=true&howMany=150', [
            'auth' => [
        ...
        // Do arrivals
        $res = $client->request('GET', 'https://flightxml.flightaware.com/json/FlightXML3/AirlineFlightSchedules?start_date=1561838400&end_date=1561863600&destination=KATL&exclude_codeshare=true&howMany=150', [
            'auth' => [
                Config::get('flights.username'), Config::get('flights.api_key')
            ]
        ]);
