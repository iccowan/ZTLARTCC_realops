...
class PullScheduledFlights extends Command
{
    ...
    public function handle()
    {
        ...
        // Do departures
        $res = $client->request('GET', 'https://flightxml.flightaware.com/json/FlightXML3/AirlineFlightSchedules?start_date=1561849200&end_date=1561863600&origin=KATL&howMany=900', [
            'auth' => [
        ...
        // Do arrivals
        $res = $client->request('GET', 'https://flightxml.flightaware.com/json/FlightXML3/AirlineFlightSchedules?start_date=1561842000&end_date=1561863600&destination=KATL&howMany=900', [
            'auth' => [
                Config::get('flights.username'), Config::get('flights.api_key')
            ]
        ]);
