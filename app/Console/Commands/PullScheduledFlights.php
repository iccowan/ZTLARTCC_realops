...
class PullScheduledFlights extends Command
{
    ...
    public function handle()
    {
        ...
        // Do departures
        $res = $client->request('GET', 'https://flightxml.flightaware.com/json/FlightXML3/AirlineFlightSchedules?start_date=1561845600&end_date=1561863600&origin=KATL&airline=AAL&exclude_codeshare=true&howMany=150', [
            'auth' => [
